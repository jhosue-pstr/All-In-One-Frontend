...
describe('storeService', () => {
  ...
  describe('Products', () => {
    it('getProducts calls fetchApi with base URL', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/productos')
    })
     ...
     it('getProducts passes query params', async () => {
       ...
       expect(mockFetchApi).toHaveBeenCalledWith(
         '/v1/sitios/1/tienda/productos?categoria_id=5&pagina=2&por_pagina=10&solo_activos=true&featured=true'
      )
    })
    ...
    it('getProduct calls fetchApi with id', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/productos/1')
    })
  ...
  describe('Categories', () => {
    it('getCategorias calls fetchApi with base URL', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/categorias?solo_activas=true')
    })

    it('getCategorias with soloActivas=false omits param', async () => {
      mockFetchApi.mockResolvedValue({ items: [] })
      await storeService.getCategorias(1, false)
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/categorias')
    })

    it('getCategoria calls fetchApi with id', async () => {
      mockFetchApi.mockResolvedValue({ id: 1 })
      await storeService.getCategoria(1, 1)
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/categorias/1')
    })
  ...
  describe('Orders', () => {
    it('getPedidos calls fetchApi with base URL', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/pedidos')
    })
    ...
    it('getPedidos passes estado param', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith(
        '/v1/sitios/1/tienda/pedidos?estado=pendiente&pagina=1&por_pagina=20'
      )
    })
    ...
    it('getPedido calls fetchApi with id', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/pedidos/1')
    })
    ...
    it('updatePedidoEstado calls fetchApi with PUT', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/pedidos/1/estado', {
        method: 'PUT',
        body: JSON.stringify(data),
      })
    })
  ...
  describe('Cart', () => {
    it('getCarrito calls fetchApi', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/carrito')
    })

    it('getCarrito with usuarioId adds query param', async () => {
      mockFetchApi.mockResolvedValue({ items: [] })
      await storeService.getCarrito(1, 5)
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/carrito?usuario_id=5')
    })
    ...
    it('addToCarrito calls fetchApi with POST', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/carrito/items', {
        method: 'POST',
        body: JSON.stringify(data),
      })
    })
    ...
    it('updateCarritoItem calls fetchApi with PUT', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith(
        '/v1/sitios/1/tienda/carrito/items/1?cantidad=3',
        { method: 'PUT' }
      )
    })
    ...
    it('removeFromCarrito calls fetchApi with DELETE', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/carrito/items/1', {
        method: 'DELETE',
      })
    })
    ...
    it('checkout calls fetchApi with POST', async () => {
      ...
      expect(mockFetchApi).toHaveBeenCalledWith('/v1/sitios/1/tienda/checkout', {
        method: 'POST',
        body: JSON.stringify(data),
      })
    })
